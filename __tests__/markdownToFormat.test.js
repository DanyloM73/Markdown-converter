...
describe('markdownToFormat', () => {
  ...
  it('should handle invalid syntax', () => {
    ...
    const expectedHtmlNestedError = 'Error converting markdown to html: Invalid markdown in line: **<tt><i>nested</i></tt>**';
    const expectedHtmlNoEndError = 'Error converting markdown to html: Invalid markdown in line: _no end';
    const expectedAnsiNestedError = 'Error converting markdown to ansi: Invalid markdown in line: **\x1b[7m\x1b[3mnested\x1b[23m\x1b[27m**';
    const expectedAnsiNoEndError = 'Error converting markdown to ansi: Invalid markdown in line: _no end';
